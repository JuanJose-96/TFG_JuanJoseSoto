...
public class TechnicianProfileController {
    ...
    public TechnicianProfileController(UpdateTechnicianProfileUseCase updateTechnicianProfileUseCase, UploadTechnicianImageUseCase uploadTechnicianImageUseCase) {
